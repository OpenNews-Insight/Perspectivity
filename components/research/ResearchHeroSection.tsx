...
const ResearchHeroSection: FC = () => {
  ...
  return (
    <section className="relative min-h-[80vh] flex items-center overflow-hidden bg-navy-deep">
      <SectionBackdrop image="/assets/images/eanat/narrative.jpg" dark />
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 1px 1px, rgba(110,231,183,0.15) 1px, transparent 0)",
          backgroundSize: "24px 24px",
        }}
      />

      {/* Blur orbs */}
      <div className="absolute top-20 -left-32 w-96 h-96 bg-[#6EE7B7] rounded-full opacity-5 blur-3xl" />
      <div className="absolute -bottom-40 -right-32 w-96 h-96 bg-[#6EE7B7] rounded-full opacity-5 blur-3xl" />
      ...
      <div className="relative z-10 container mx-auto px-5 sm:px-10 md:px-20 pt-28 sm:pt-36 pb-16 sm:pb-24">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <span className="font-hanken text-paragraph-sm-medium text-white/80">
              BanglaLLM Research
            </span>
          </div>
          ...
          >
            ...
            <span className="italic text-[#6EE7B7]">for Bangla</span>
          </h1>

          {/* Subtext paragraph */}
          <p
            className={cn(
              "font-hanken text-paragraph-lg-regular text-white/65 max-w-2xl mx-auto mb-10 transition-all duration-1000 delay-300",
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            )}
          >
          ...
          >
            {["31+ Models", "7+ Datasets", "3+ Papers"].map((stat) => (
              <span
                key={stat}
                className="inline-flex items-center gap-2 rounded-full px-5 py-2.5 font-hanken text-paragraph-md-medium text-white/80 border border-white/10 backdrop-blur-sm bg-white/5 hover:bg-white/10 transition-colors duration-300"
              >

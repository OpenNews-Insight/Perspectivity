...
const DemoSection: FC = () => {
  ...
  return (
    ...
    >
      {/* Rotated Badge */}
      <div
        className={`relative bg-primary-50 w-max border border-primary-100 shadow-primary-50 p-3 rounded-full flex justify-start gap-3 items-center rotate-[10.35deg] mb-[90px] z-20
